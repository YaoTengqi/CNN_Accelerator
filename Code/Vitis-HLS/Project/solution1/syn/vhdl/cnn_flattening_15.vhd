...
architecture behav of cnn_flattening_15 is 
...
attribute shreg_extract : string;
    ...
    signal pool_to_flat_streams_1_read_reg_92 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln11_fu_65_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                pool_to_flat_streams_1_read_reg_92 <= pool_to_flat_streams_1_dout;
            end if;
        end if;
    end process;
    ...
    ap_block_pp0_stage0_01001_assign_proc : process(ap_enable_reg_pp0_iter1, pool_to_flat_streams_1_empty_n, icmp_ln11_fu_65_p2, ap_done_reg, flat_to_dense_streams_1_full_n, ap_start_int)
    begin
                ap_block_pp0_stage0_01001 <= ((ap_done_reg = ap_const_logic_1) or ((flat_to_dense_streams_1_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start_int = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((icmp_ln11_fu_65_p2 = ap_const_lv1_0) and (pool_to_flat_streams_1_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, pool_to_flat_streams_1_empty_n, icmp_ln11_fu_65_p2, ap_done_reg, flat_to_dense_streams_1_full_n, ap_start_int)
    begin
                ap_block_pp0_stage0_11001 <= ((ap_done_reg = ap_const_logic_1) or ((flat_to_dense_streams_1_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start_int = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((icmp_ln11_fu_65_p2 = ap_const_lv1_0) and (pool_to_flat_streams_1_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, pool_to_flat_streams_1_empty_n, icmp_ln11_fu_65_p2, ap_done_reg, flat_to_dense_streams_1_full_n, ap_start_int)
    begin
                ap_block_pp0_stage0_subdone <= ((ap_done_reg = ap_const_logic_1) or ((flat_to_dense_streams_1_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)) or ((ap_start_int = ap_const_logic_1) and ((ap_done_reg = ap_const_logic_1) or ((icmp_ln11_fu_65_p2 = ap_const_lv1_0) and (pool_to_flat_streams_1_empty_n = ap_const_logic_0)))));
    end process;


    ap_block_state1_pp0_stage0_iter0_assign_proc : process(pool_to_flat_streams_1_empty_n, icmp_ln11_fu_65_p2, ap_done_reg)
    begin
                ap_block_state1_pp0_stage0_iter0 <= ((ap_done_reg = ap_const_logic_1) or ((icmp_ln11_fu_65_p2 = ap_const_lv1_0) and (pool_to_flat_streams_1_empty_n = ap_const_logic_0)));
    end process;


    ap_block_state2_pp0_stage0_iter1_assign_proc : process(flat_to_dense_streams_1_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= (flat_to_dense_streams_1_full_n = ap_const_logic_0);
    end process;
    ...
    flat_to_dense_streams_1_din <= pool_to_flat_streams_1_read_reg_92;
    ...
    pool_to_flat_streams_1_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, pool_to_flat_streams_1_empty_n, icmp_ln11_fu_65_p2, ap_done_reg, ap_block_pp0_stage0, ap_start_int)
    begin
    ...
    pool_to_flat_streams_1_read_assign_proc : process(ap_CS_fsm_pp0_stage0, icmp_ln11_fu_65_p2, ap_block_pp0_stage0_11001, ap_start_int)
    begin
