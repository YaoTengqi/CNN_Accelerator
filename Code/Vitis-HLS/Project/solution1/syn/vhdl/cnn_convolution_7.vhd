...
attribute shreg_extract : string;
    ...
    signal weight_buf_load_1_reg_227 : STD_LOGIC_VECTOR (31 downto 0);
    signal weight_buf_load_2_reg_232 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal weight_buf_load_3_reg_247 : STD_LOGIC_VECTOR (31 downto 0);
    signal weight_buf_load_4_reg_252 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal weight_buf_load_5_reg_267 : STD_LOGIC_VECTOR (31 downto 0);
    signal weight_buf_load_6_reg_272 : STD_LOGIC_VECTOR (31 downto 0);
    signal weight_buf_load_7_reg_277 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal weight_buf_load_8_reg_282 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal grp_fu_156_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal conv1_reg_292 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal w_1_reg_302 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_169_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal w_2_reg_307 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_173_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal w_3_reg_312 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_177_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal w_4_reg_317 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_181_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal w_5_reg_322 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_185_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal w_6_reg_327 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_189_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal w_7_reg_332 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_193_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal w_8_reg_337 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start : STD_LOGIC;
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done : STD_LOGIC;
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_idle : STD_LOGIC;
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_ready : STD_LOGIC;
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_ce0 : STD_LOGIC;
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_address1 : STD_LOGIC_VECTOR (9 downto 0);
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_ce1 : STD_LOGIC;
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_conv_to_pool_streams_7_din : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_conv_to_pool_streams_7_write : STD_LOGIC;
    signal grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138 : component cnn_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    sitofp_32ns_32_6_no_dsp_1_U267 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_6_no_dsp_1_U268 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_6_no_dsp_1_U269 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_6_no_dsp_1_U270 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_6_no_dsp_1_U271 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_6_no_dsp_1_U272 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_6_no_dsp_1_U273 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_6_no_dsp_1_U274 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_6_no_dsp_1_U275 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    sitofp_32ns_32_6_no_dsp_1_U276 : component cnn_sitofp_32ns_32_6_no_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state13) and (grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done = ap_const_logic_1))) then 
    ...
    grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
                    grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_ready = ap_const_logic_1)) then 
                    grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done, ap_CS_fsm_state13)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state13 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state13) and (grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state13;
                end if;
    ...
    ap_ST_fsm_state13_blk_assign_proc : process(grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done)
    begin
        if ((grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done = ap_const_logic_0)) then 
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done, ap_CS_fsm_state13)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state13) and (grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done = ap_const_logic_1))) then 
    ...
    ap_ready_assign_proc : process(grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done, ap_CS_fsm_state13)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state13) and (grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done = ap_const_logic_1))) then 
    ...
    conv_to_pool_streams_7_write_assign_proc : process(grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_conv_to_pool_streams_7_write, ap_CS_fsm_state13)
    begin
    ...
    grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start <= grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg;
    pad_img_address0 <= grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_address0;
    pad_img_address1 <= grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_address1;
    pad_img_ce0 <= grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_ce0;
    pad_img_ce1 <= grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_ce1;
