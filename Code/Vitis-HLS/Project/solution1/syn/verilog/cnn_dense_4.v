...
wire   [3:0] dense_array_addr_28_reg_359;
wire   [3:0] dense_array_addr_29_reg_364;
wire    ap_CS_fsm_state4;
wire   [3:0] dense_array_addr_30_reg_369;
wire   [31:0] dense_array_q1;
reg   [31:0] dense_array_load_reg_374;
wire   [31:0] dense_array_q0;
reg   [31:0] dense_array_load_28_reg_379;
wire   [3:0] dense_array_addr_31_reg_384;
wire    ap_CS_fsm_state5;
wire   [3:0] dense_array_addr_32_reg_389;
reg   [31:0] dense_array_load_29_reg_394;
reg   [31:0] dense_array_load_30_reg_399;
wire   [3:0] dense_array_addr_33_reg_404;
wire    ap_CS_fsm_state6;
wire   [3:0] dense_array_addr_34_reg_409;
reg   [31:0] dense_array_load_31_reg_414;
reg   [31:0] dense_array_load_32_reg_419;
wire   [3:0] dense_array_addr_35_reg_424;
wire    ap_CS_fsm_state7;
wire   [3:0] dense_array_addr_36_reg_429;
reg   [31:0] dense_array_load_33_reg_434;
reg   [31:0] dense_array_load_34_reg_439;
reg   [31:0] dense_array_load_35_reg_444;
wire    ap_CS_fsm_state8;
reg   [31:0] dense_array_load_36_reg_449;
...
wire    grp_dense_4_Pipeline_1_fu_193_ap_start;
wire    grp_dense_4_Pipeline_1_fu_193_ap_done;
wire    grp_dense_4_Pipeline_1_fu_193_ap_idle;
wire    grp_dense_4_Pipeline_1_fu_193_ap_ready;
wire   [3:0] grp_dense_4_Pipeline_1_fu_193_dense_array_address0;
wire    grp_dense_4_Pipeline_1_fu_193_dense_array_ce0;
wire    grp_dense_4_Pipeline_1_fu_193_dense_array_we0;
wire   [31:0] grp_dense_4_Pipeline_1_fu_193_dense_array_d0;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_start;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_done;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_idle;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_ready;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_flat_to_dense_streams_4_read;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_914_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_914_out_ap_vld;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_813_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_813_out_ap_vld;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_712_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_712_out_ap_vld;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_611_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_611_out_ap_vld;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_510_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_510_out_ap_vld;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_49_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_49_out_ap_vld;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_38_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_38_out_ap_vld;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_27_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_27_out_ap_vld;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_16_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add7_16_out_ap_vld;
wire   [31:0] grp_dense_4_Pipeline_dense_for_flat_fu_199_add75_out;
wire    grp_dense_4_Pipeline_dense_for_flat_fu_199_add75_out_ap_vld;
wire    grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_start;
wire    grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_done;
wire    grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_idle;
wire    grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_ready;
wire   [31:0] grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_dense_to_softmax_streams_4_din;
wire    grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_dense_to_softmax_streams_4_write;
wire   [3:0] grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_dense_array_address0;
wire    grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_dense_array_ce0;
reg    grp_dense_4_Pipeline_1_fu_193_ap_start_reg;
reg    ap_block_state1_ignore_call13;
wire    ap_CS_fsm_state2;
reg    grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_start_reg;
wire    ap_CS_fsm_state9;
reg    grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 16'd1;
#0 grp_dense_4_Pipeline_1_fu_193_ap_start_reg = 1'b0;
#0 grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_start_reg = 1'b0;
#0 grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_start_reg = 1'b0;
end
...
cnn_dense_4_Pipeline_1 grp_dense_4_Pipeline_1_fu_193(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cnn_dense_4_Pipeline_dense_for_flat grp_dense_4_Pipeline_dense_for_flat_fu_199(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
cnn_dense_4_Pipeline_VITIS_LOOP_60_2 grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state16) & (grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_done == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dense_4_Pipeline_1_fu_193_ap_start_reg <= 1'b0;
    end else begin
        if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
            grp_dense_4_Pipeline_1_fu_193_ap_start_reg <= 1'b1;
        end else if ((grp_dense_4_Pipeline_1_fu_193_ap_ready == 1'b1)) begin
            grp_dense_4_Pipeline_1_fu_193_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state15)) begin
            grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_start_reg <= 1'b1;
        end else if ((grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_ready == 1'b1)) begin
            grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state8)) begin
            grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_start_reg <= 1'b1;
        end else if ((grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_ready == 1'b1)) begin
            grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((grp_dense_4_Pipeline_1_fu_193_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state16) & (grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (grp_dense_4_Pipeline_1_fu_193_ap_done == 1'b1))) begin
        ...
        ap_ST_fsm_state9 : begin
            if (((1'b1 == ap_CS_fsm_state9) & (grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_done == 1'b1))) begin
...
assign dense_array_addr_28_reg_359 = 64'd1;

assign dense_array_addr_29_reg_364 = 64'd2;

assign dense_array_addr_30_reg_369 = 64'd3;

assign dense_array_addr_31_reg_384 = 64'd4;

assign dense_array_addr_32_reg_389 = 64'd5;

assign dense_array_addr_33_reg_404 = 64'd6;

assign dense_array_addr_34_reg_409 = 64'd7;

assign dense_array_addr_35_reg_424 = 64'd8;

assign dense_array_addr_36_reg_429 = 64'd9;

assign dense_array_addr_reg_354 = 64'd0;

assign dense_to_softmax_streams_4_din = grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_dense_to_softmax_streams_4_din;

assign grp_dense_4_Pipeline_1_fu_193_ap_start = grp_dense_4_Pipeline_1_fu_193_ap_start_reg;

assign grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_start = grp_dense_4_Pipeline_VITIS_LOOP_60_2_fu_247_ap_start_reg;

assign grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_start = grp_dense_4_Pipeline_dense_for_flat_fu_199_ap_start_reg;

endmodule //cnn_dense_4
