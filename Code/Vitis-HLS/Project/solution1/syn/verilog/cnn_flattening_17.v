...
reg   [31:0] pool_to_flat_streams_3_read_reg_92;
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((flat_to_dense_streams_3_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((icmp_ln11_fu_65_p2 == 1'd0) & (pool_to_flat_streams_3_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_done_reg == 1'b1) | ((flat_to_dense_streams_3_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((icmp_ln11_fu_65_p2 == 1'd0) & (pool_to_flat_streams_3_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_done_reg == 1'b1) | ((flat_to_dense_streams_3_full_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((ap_start_int == 1'b1) & ((ap_done_reg == 1'b1) | ((icmp_ln11_fu_65_p2 == 1'd0) & (pool_to_flat_streams_3_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_done_reg == 1'b1) | ((icmp_ln11_fu_65_p2 == 1'd0) & (pool_to_flat_streams_3_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (flat_to_dense_streams_3_full_n == 1'b0);
end
...
assign flat_to_dense_streams_3_din = pool_to_flat_streams_3_read_reg_92;

assign icmp_ln11_fu_65_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 8'd196) ? 1'b1 : 1'b0);

endmodule //cnn_flattening_17
