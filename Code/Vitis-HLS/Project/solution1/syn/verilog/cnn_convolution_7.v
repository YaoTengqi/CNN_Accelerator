...
reg   [31:0] weight_buf_load_1_reg_188;
reg   [31:0] weight_buf_load_2_reg_193;
wire    ap_CS_fsm_state4;
reg   [31:0] weight_buf_load_3_reg_208;
reg   [31:0] weight_buf_load_4_reg_213;
wire    ap_CS_fsm_state5;
reg   [31:0] weight_buf_load_5_reg_233;
reg   [31:0] weight_buf_load_6_reg_238;
reg   [31:0] weight_buf_load_7_reg_243;
wire    ap_CS_fsm_state6;
reg   [31:0] weight_buf_load_8_reg_248;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state7) & (grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state7) & (grp_convolution_7_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
