...
wire    dense_1_U0_flat_to_dense_streams_1_read;
wire   [31:0] dense_1_U0_dense_to_softmax_streams_1_din;
wire    dense_1_U0_dense_to_softmax_streams_1_write;
wire    dense_2_U0_ap_start;
wire    dense_2_U0_ap_done;
wire    dense_2_U0_ap_continue;
wire    dense_2_U0_ap_idle;
wire    dense_2_U0_ap_ready;
wire    dense_2_U0_flat_to_dense_streams_2_read;
wire   [31:0] dense_2_U0_dense_to_softmax_streams_2_din;
wire    dense_2_U0_dense_to_softmax_streams_2_write;
wire    dense_3_U0_ap_start;
wire    dense_3_U0_ap_done;
wire    dense_3_U0_ap_continue;
wire    dense_3_U0_ap_idle;
wire    dense_3_U0_ap_ready;
wire    dense_3_U0_flat_to_dense_streams_3_read;
wire   [31:0] dense_3_U0_dense_to_softmax_streams_3_din;
wire    dense_3_U0_dense_to_softmax_streams_3_write;
...
wire    dense_4_U0_flat_to_dense_streams_4_read;
wire   [31:0] dense_4_U0_dense_to_softmax_streams_4_din;
wire    dense_4_U0_dense_to_softmax_streams_4_write;
wire    dense_5_U0_ap_start;
wire    dense_5_U0_ap_done;
wire    dense_5_U0_ap_continue;
wire    dense_5_U0_ap_idle;
wire    dense_5_U0_ap_ready;
wire    dense_5_U0_flat_to_dense_streams_5_read;
wire   [31:0] dense_5_U0_dense_to_softmax_streams_5_din;
wire    dense_5_U0_dense_to_softmax_streams_5_write;
wire    dense_6_U0_ap_start;
wire    dense_6_U0_ap_done;
wire    dense_6_U0_ap_continue;
wire    dense_6_U0_ap_idle;
wire    dense_6_U0_ap_ready;
wire    dense_6_U0_flat_to_dense_streams_6_read;
wire   [31:0] dense_6_U0_dense_to_softmax_streams_6_din;
wire    dense_6_U0_dense_to_softmax_streams_6_write;
wire    dense_7_U0_ap_start;
wire    dense_7_U0_ap_done;
wire    dense_7_U0_ap_continue;
wire    dense_7_U0_ap_idle;
wire    dense_7_U0_ap_ready;
wire    dense_7_U0_flat_to_dense_streams_7_read;
wire   [31:0] dense_7_U0_dense_to_softmax_streams_7_din;
wire    dense_7_U0_dense_to_softmax_streams_7_write;
wire    ap_sync_done;
wire    ap_sync_ready;
reg    ap_sync_reg_dense_U0_ap_ready;
wire    ap_sync_dense_U0_ap_ready;
reg    ap_sync_reg_dense_1_U0_ap_ready;
wire    ap_sync_dense_1_U0_ap_ready;
reg    ap_sync_reg_dense_2_U0_ap_ready;
wire    ap_sync_dense_2_U0_ap_ready;
reg    ap_sync_reg_dense_3_U0_ap_ready;
wire    ap_sync_dense_3_U0_ap_ready;
reg    ap_sync_reg_dense_4_U0_ap_ready;
wire    ap_sync_dense_4_U0_ap_ready;
reg    ap_sync_reg_dense_5_U0_ap_ready;
wire    ap_sync_dense_5_U0_ap_ready;
reg    ap_sync_reg_dense_6_U0_ap_ready;
wire    ap_sync_dense_6_U0_ap_ready;
reg    ap_sync_reg_dense_7_U0_ap_ready;
wire    ap_sync_dense_7_U0_ap_ready;
wire    ap_ce_reg;

// power-on initialization
initial begin
#0 ap_sync_reg_dense_U0_ap_ready = 1'b0;
#0 ap_sync_reg_dense_1_U0_ap_ready = 1'b0;
#0 ap_sync_reg_dense_2_U0_ap_ready = 1'b0;
#0 ap_sync_reg_dense_3_U0_ap_ready = 1'b0;
#0 ap_sync_reg_dense_4_U0_ap_ready = 1'b0;
#0 ap_sync_reg_dense_5_U0_ap_ready = 1'b0;
#0 ap_sync_reg_dense_6_U0_ap_ready = 1'b0;
#0 ap_sync_reg_dense_7_U0_ap_ready = 1'b0;
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dense_1_U0_ap_ready <= 1'b0;
    end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dense_2_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_dense_2_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dense_3_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_dense_3_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dense_4_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_dense_4_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dense_5_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_dense_5_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dense_6_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_dense_6_U0_ap_ready <= 1'b0;
        end else begin
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dense_7_U0_ap_ready <= 1'b0;
    end else begin
        if (((ap_sync_ready & ap_start) == 1'b1)) begin
            ap_sync_reg_dense_7_U0_ap_ready <= 1'b0;
        end else begin
...
assign ap_idle = (dense_U0_ap_idle & dense_7_U0_ap_idle & dense_6_U0_ap_idle & dense_5_U0_ap_idle & dense_4_U0_ap_idle & dense_3_U0_ap_idle & dense_2_U0_ap_idle & dense_1_U0_ap_idle);

assign ap_ready = ap_sync_ready;

assign ap_sync_continue = (ap_sync_done & ap_continue);

assign ap_sync_dense_1_U0_ap_ready = (dense_1_U0_ap_ready | ap_sync_reg_dense_1_U0_ap_ready);

assign ap_sync_dense_2_U0_ap_ready = (dense_2_U0_ap_ready | ap_sync_reg_dense_2_U0_ap_ready);

assign ap_sync_dense_3_U0_ap_ready = (dense_3_U0_ap_ready | ap_sync_reg_dense_3_U0_ap_ready);

assign ap_sync_dense_4_U0_ap_ready = (dense_4_U0_ap_ready | ap_sync_reg_dense_4_U0_ap_ready);

assign ap_sync_dense_5_U0_ap_ready = (dense_5_U0_ap_ready | ap_sync_reg_dense_5_U0_ap_ready);

assign ap_sync_dense_6_U0_ap_ready = (dense_6_U0_ap_ready | ap_sync_reg_dense_6_U0_ap_ready);

assign ap_sync_dense_7_U0_ap_ready = (dense_7_U0_ap_ready | ap_sync_reg_dense_7_U0_ap_ready);

assign ap_sync_dense_U0_ap_ready = (dense_U0_ap_ready | ap_sync_reg_dense_U0_ap_ready);

assign ap_sync_done = (dense_U0_ap_done & dense_7_U0_ap_done & dense_6_U0_ap_done & dense_5_U0_ap_done & dense_4_U0_ap_done & dense_3_U0_ap_done & dense_2_U0_ap_done & dense_1_U0_ap_done);

assign ap_sync_ready = (ap_sync_dense_U0_ap_ready & ap_sync_dense_7_U0_ap_ready & ap_sync_dense_6_U0_ap_ready & ap_sync_dense_5_U0_ap_ready & ap_sync_dense_4_U0_ap_ready & ap_sync_dense_3_U0_ap_ready & ap_sync_dense_2_U0_ap_ready & ap_sync_dense_1_U0_ap_ready);

assign dense_1_U0_ap_continue = ap_sync_continue;

assign dense_1_U0_ap_start = ((ap_sync_reg_dense_1_U0_ap_ready ^ 1'b1) & ap_start);

assign dense_2_U0_ap_continue = ap_sync_continue;

assign dense_2_U0_ap_start = ((ap_sync_reg_dense_2_U0_ap_ready ^ 1'b1) & ap_start);

assign dense_3_U0_ap_continue = ap_sync_continue;

assign dense_3_U0_ap_start = ((ap_sync_reg_dense_3_U0_ap_ready ^ 1'b1) & ap_start);

assign dense_4_U0_ap_continue = ap_sync_continue;

assign dense_4_U0_ap_start = ((ap_sync_reg_dense_4_U0_ap_ready ^ 1'b1) & ap_start);

assign dense_5_U0_ap_continue = ap_sync_continue;

assign dense_5_U0_ap_start = ((ap_sync_reg_dense_5_U0_ap_ready ^ 1'b1) & ap_start);

assign dense_6_U0_ap_continue = ap_sync_continue;

assign dense_6_U0_ap_start = ((ap_sync_reg_dense_6_U0_ap_ready ^ 1'b1) & ap_start);

assign dense_7_U0_ap_continue = ap_sync_continue;

assign dense_7_U0_ap_start = ((ap_sync_reg_dense_7_U0_ap_ready ^ 1'b1) & ap_start);
...
assign dense_to_softmax_streams_1_din = dense_1_U0_dense_to_softmax_streams_1_din;

assign dense_to_softmax_streams_1_write = dense_1_U0_dense_to_softmax_streams_1_write;

assign dense_to_softmax_streams_2_din = dense_2_U0_dense_to_softmax_streams_2_din;

assign dense_to_softmax_streams_2_write = dense_2_U0_dense_to_softmax_streams_2_write;

assign dense_to_softmax_streams_3_din = dense_3_U0_dense_to_softmax_streams_3_din;

assign dense_to_softmax_streams_3_write = dense_3_U0_dense_to_softmax_streams_3_write;

assign dense_to_softmax_streams_4_din = dense_4_U0_dense_to_softmax_streams_4_din;

assign dense_to_softmax_streams_4_write = dense_4_U0_dense_to_softmax_streams_4_write;

assign dense_to_softmax_streams_5_din = dense_5_U0_dense_to_softmax_streams_5_din;

assign dense_to_softmax_streams_5_write = dense_5_U0_dense_to_softmax_streams_5_write;

assign dense_to_softmax_streams_6_din = dense_6_U0_dense_to_softmax_streams_6_din;

assign dense_to_softmax_streams_6_write = dense_6_U0_dense_to_softmax_streams_6_write;

assign dense_to_softmax_streams_7_din = dense_7_U0_dense_to_softmax_streams_7_din;

assign dense_to_softmax_streams_7_write = dense_7_U0_dense_to_softmax_streams_7_write;

assign flat_to_dense_streams_0_read = dense_U0_flat_to_dense_streams_0_read;

assign flat_to_dense_streams_1_read = dense_1_U0_flat_to_dense_streams_1_read;

assign flat_to_dense_streams_2_read = dense_2_U0_flat_to_dense_streams_2_read;

assign flat_to_dense_streams_3_read = dense_3_U0_flat_to_dense_streams_3_read;

assign flat_to_dense_streams_4_read = dense_4_U0_flat_to_dense_streams_4_read;

assign flat_to_dense_streams_5_read = dense_5_U0_flat_to_dense_streams_5_read;

assign flat_to_dense_streams_6_read = dense_6_U0_flat_to_dense_streams_6_read;

assign flat_to_dense_streams_7_read = dense_7_U0_flat_to_dense_streams_7_read;
