...
set portList { 
	...
	{ pool_to_flat_streams_7_dout sc_in sc_lv 32 signal 0 } 
	{ pool_to_flat_streams_7_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ pool_to_flat_streams_7_fifo_cap sc_in sc_lv 9 signal 0 } 
	{ pool_to_flat_streams_7_empty_n sc_in sc_logic 1 signal 0 } 
	{ pool_to_flat_streams_7_read sc_out sc_logic 1 signal 0 } 
	{ flat_to_dense_streams_7_din sc_out sc_lv 32 signal 1 } 
	{ flat_to_dense_streams_7_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ flat_to_dense_streams_7_fifo_cap sc_in sc_lv 9 signal 1 } 
	{ flat_to_dense_streams_7_full_n sc_in sc_logic 1 signal 1 } 
	{ flat_to_dense_streams_7_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	pool_to_flat_streams_7 { ap_fifo {  { pool_to_flat_streams_7_dout fifo_port_we 0 32 }  { pool_to_flat_streams_7_num_data_valid fifo_status_num_data_valid 0 9 }  { pool_to_flat_streams_7_fifo_cap fifo_update 0 9 }  { pool_to_flat_streams_7_empty_n fifo_status 0 1 }  { pool_to_flat_streams_7_read fifo_data 1 1 } } }
	flat_to_dense_streams_7 { ap_fifo {  { flat_to_dense_streams_7_din fifo_port_we 1 32 }  { flat_to_dense_streams_7_num_data_valid fifo_status_num_data_valid 0 9 }  { flat_to_dense_streams_7_fifo_cap fifo_update 0 9 }  { flat_to_dense_streams_7_full_n fifo_status 0 1 }  { flat_to_dense_streams_7_write fifo_data 1 1 } } }
}
