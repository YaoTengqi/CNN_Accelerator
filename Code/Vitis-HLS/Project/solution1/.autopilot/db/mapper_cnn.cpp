...
using hls::sim::Byte;
extern "C" void cnn(Byte<4>*, Byte<4>*, Byte<4>*, Byte<4>*);
...
std::vector<Byte<4>> __xlx_weight_buf__tmp_vec;
for (size_t i = 0; i < 72; ++i){
__xlx_weight_buf__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_weight_buf)[i]);
}
...
std::vector<Byte<4>> __xlx_biases_buf__tmp_vec;
for (size_t i = 0; i < 8; ++i){
__xlx_biases_buf__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_biases_buf)[i]);
}
  int __xlx_size_param_biases_buf = 8;
  int __xlx_offset_param_biases_buf = 0;
  int __xlx_offset_byte_param_biases_buf = 0*4;
  // DUT call
  cnn(__xlx_img_in__tmp_vec.data(), __xlx_prediction__tmp_vec.data(), __xlx_weight_buf__tmp_vec.data(), __xlx_biases_buf__tmp_vec.data());
...
for (size_t i = 0; i < __xlx_size_param_weight_buf; ++i) {
((Byte<4>*)__xlx_apatb_param_weight_buf)[i] = __xlx_weight_buf__tmp_vec[__xlx_offset_param_weight_buf+i];
}
// print __xlx_apatb_param_biases_buf
for (size_t i = 0; i < __xlx_size_param_biases_buf; ++i) {
((Byte<4>*)__xlx_apatb_param_biases_buf)[i] = __xlx_biases_buf__tmp_vec[__xlx_offset_param_biases_buf+i];
}
}
