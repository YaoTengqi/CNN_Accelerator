...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { dense_to_softmax_streams_5_din { O 32 vector } dense_to_softmax_streams_5_num_data_valid { I 5 vector } dense_to_softmax_streams_5_fifo_cap { I 5 vector } dense_to_softmax_streams_5_full_n { I 1 bit } dense_to_softmax_streams_5_write { O 1 bit } } \
} "
}
