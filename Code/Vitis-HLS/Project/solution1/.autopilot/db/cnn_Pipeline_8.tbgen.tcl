...
set C_modelArgMapList {[ 
	{ "Name" : "weight_buf_5", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ weight_buf_5_address0 sc_out sc_lv 4 signal 0 } 
	{ weight_buf_5_ce0 sc_out sc_logic 1 signal 0 } 
	{ weight_buf_5_we0 sc_out sc_logic 1 signal 0 } 
	{ weight_buf_5_d0 sc_out sc_lv 32 signal 0 } 
...
set Spec2ImplPortList { 
	weight_buf_5 { ap_memory {  { weight_buf_5_address0 mem_address 1 4 }  { weight_buf_5_ce0 mem_ce 1 1 }  { weight_buf_5_we0 mem_we 1 1 }  { weight_buf_5_d0 mem_din 1 32 } } }
