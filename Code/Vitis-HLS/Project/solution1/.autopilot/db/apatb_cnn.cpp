...
extern "C"
void cnn_hw_stub_wrapper(void*, void*, void*, void*);

extern "C"
void apatb_cnn_hw(void* __xlx_apatb_param_img_in, void* __xlx_apatb_param_prediction, void* __xlx_apatb_param_weight_buf, void* __xlx_apatb_param_biases_buf)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port2 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_weight_buf),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_weight_buf),
#endif
#endif
  };
  port2.param = { __xlx_apatb_param_weight_buf };
  port2.depth = { 72 };
  port2.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port3 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_biases_buf),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_biases_buf),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_biases_buf };
  port3.depth = { 8 };
  port3.offset = {  };
