...
set portList { 
	...
	{ pool_to_flat_streams_3_num_data_valid sc_in sc_lv 9 signal 0 } 
	{ pool_to_flat_streams_3_fifo_cap sc_in sc_lv 9 signal 0 } 
	...
	{ flat_to_dense_streams_3_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ flat_to_dense_streams_3_fifo_cap sc_in sc_lv 9 signal 1 } 
...
set Spec2ImplPortList { 
	pool_to_flat_streams_3 { ap_fifo {  { pool_to_flat_streams_3_dout fifo_port_we 0 32 }  { pool_to_flat_streams_3_num_data_valid fifo_status_num_data_valid 0 9 }  { pool_to_flat_streams_3_fifo_cap fifo_update 0 9 }  { pool_to_flat_streams_3_empty_n fifo_status 0 1 }  { pool_to_flat_streams_3_read fifo_data 1 1 } } }
	flat_to_dense_streams_3 { ap_fifo {  { flat_to_dense_streams_3_din fifo_port_we 1 32 }  { flat_to_dense_streams_3_num_data_valid fifo_status_num_data_valid 0 9 }  { flat_to_dense_streams_3_fifo_cap fifo_update 0 9 }  { flat_to_dense_streams_3_full_n fifo_status 0 1 }  { flat_to_dense_streams_3_write fifo_data 1 1 } } }
}
