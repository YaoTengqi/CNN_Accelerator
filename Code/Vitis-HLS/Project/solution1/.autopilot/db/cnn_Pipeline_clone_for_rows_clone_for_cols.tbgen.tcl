...
set C_modelArgList {
	{ pad_img float 32 regular {array 900 { 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ pad_img1 float 32 regular {array 900 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ pad_img2 float 32 regular {array 900 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ pad_img3 float 32 regular {array 900 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ pad_img4 float 32 regular {array 900 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ pad_img5 float 32 regular {array 900 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ pad_img6 float 32 regular {array 900 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
	{ pad_img7 float 32 regular {array 900 { 0 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "pad_img", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "pad_img4", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "pad_img5", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "pad_img6", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "pad_img7", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set Spec2ImplPortList { 
	pad_img { ap_memory {  { pad_img_address0 mem_address 1 10 }  { pad_img_ce0 mem_ce 1 1 }  { pad_img_q0 in_data 0 32 } } }
	pad_img1 { ap_memory {  { pad_img1_address0 mem_address 1 10 }  { pad_img1_ce0 mem_ce 1 1 }  { pad_img1_we0 mem_we 1 1 }  { pad_img1_d0 mem_din 1 32 } } }
	pad_img2 { ap_memory {  { pad_img2_address0 mem_address 1 10 }  { pad_img2_ce0 mem_ce 1 1 }  { pad_img2_we0 mem_we 1 1 }  { pad_img2_d0 mem_din 1 32 } } }
	pad_img3 { ap_memory {  { pad_img3_address0 mem_address 1 10 }  { pad_img3_ce0 mem_ce 1 1 }  { pad_img3_we0 mem_we 1 1 }  { pad_img3_d0 mem_din 1 32 } } }
	pad_img4 { ap_memory {  { pad_img4_address0 mem_address 1 10 }  { pad_img4_ce0 mem_ce 1 1 }  { pad_img4_we0 mem_we 1 1 }  { pad_img4_d0 mem_din 1 32 } } }
	pad_img5 { ap_memory {  { pad_img5_address0 mem_address 1 10 }  { pad_img5_ce0 mem_ce 1 1 }  { pad_img5_we0 mem_we 1 1 }  { pad_img5_d0 mem_din 1 32 } } }
	pad_img6 { ap_memory {  { pad_img6_address0 mem_address 1 10 }  { pad_img6_ce0 mem_ce 1 1 }  { pad_img6_we0 mem_we 1 1 }  { pad_img6_d0 mem_din 1 32 } } }
	pad_img7 { ap_memory {  { pad_img7_address0 mem_address 1 10 }  { pad_img7_ce0 mem_ce 1 1 }  { pad_img7_we0 mem_we 1 1 }  { pad_img7_d0 mem_din 1 32 } } }
}
