...
set hasInterrupt 0
set C_modelName {max_pooling.14}
...
set portList { 
	...
	{ conv_to_pool_streams_7_dout sc_in sc_lv 32 signal 0 } 
	{ conv_to_pool_streams_7_num_data_valid sc_in sc_lv 11 signal 0 } 
	{ conv_to_pool_streams_7_fifo_cap sc_in sc_lv 11 signal 0 } 
	{ conv_to_pool_streams_7_empty_n sc_in sc_logic 1 signal 0 } 
	{ conv_to_pool_streams_7_read sc_out sc_logic 1 signal 0 } 
	{ pool_to_flat_streams_7_din sc_out sc_lv 32 signal 1 } 
	{ pool_to_flat_streams_7_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ pool_to_flat_streams_7_fifo_cap sc_in sc_lv 9 signal 1 } 
	{ pool_to_flat_streams_7_full_n sc_in sc_logic 1 signal 1 } 
	{ pool_to_flat_streams_7_write sc_out sc_logic 1 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "pool_to_flat_streams_7_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "pool_to_flat_streams_7", "role": "num_data_valid" }} , 
 	{ "name": "pool_to_flat_streams_7_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":9, "type": "signal", "bundle":{"name": "pool_to_flat_streams_7", "role": "fifo_cap" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U253", "Parent" : "0"},
...
set Spec2ImplPortList { 
	conv_to_pool_streams_7 { ap_fifo {  { conv_to_pool_streams_7_dout fifo_port_we 0 32 }  { conv_to_pool_streams_7_num_data_valid fifo_status_num_data_valid 0 11 }  { conv_to_pool_streams_7_fifo_cap fifo_update 0 11 }  { conv_to_pool_streams_7_empty_n fifo_status 0 1 }  { conv_to_pool_streams_7_read fifo_data 1 1 } } }
	pool_to_flat_streams_7 { ap_fifo {  { pool_to_flat_streams_7_din fifo_port_we 1 32 }  { pool_to_flat_streams_7_num_data_valid fifo_status_num_data_valid 0 9 }  { pool_to_flat_streams_7_fifo_cap fifo_update 0 9 }  { pool_to_flat_streams_7_full_n fifo_status 0 1 }  { pool_to_flat_streams_7_write fifo_data 1 1 } } }
}
