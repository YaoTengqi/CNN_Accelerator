set moduleName convolution_1_Pipeline_conv_for_rows_win_for_rows_win_for_cols
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {convolution.1_Pipeline_conv_for_rows_win_for_rows_win_for_cols}
set C_modelType { void 0 }
set C_modelArgList {
	{ pad_img float 32 regular {array 900 { 1 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
	{ w float 32 regular  }
	{ w_49 float 32 regular  }
	{ w_50 float 32 regular  }
	{ w_51 float 32 regular  }
	{ w_52 float 32 regular  }
	{ w_53 float 32 regular  }
	{ w_54 float 32 regular  }
	{ w_55 float 32 regular  }
	{ w_56 float 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "pad_img", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "w_49", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "w_50", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "w_51", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "w_52", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "w_53", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "w_54", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "w_55", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "w_56", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ w_49 sc_in sc_lv 32 signal 2 } 
	{ w_50 sc_in sc_lv 32 signal 3 } 
	{ w_51 sc_in sc_lv 32 signal 4 } 
	{ w_52 sc_in sc_lv 32 signal 5 } 
	{ w_53 sc_in sc_lv 32 signal 6 } 
	{ w_54 sc_in sc_lv 32 signal 7 } 
	{ w_55 sc_in sc_lv 32 signal 8 } 
	{ w_56 sc_in sc_lv 32 signal 9 } 
	{ biases_buf sc_in sc_lv 32 signal 10 } 
	{ conv_to_pool_streams_1_din sc_out sc_lv 32 signal 11 } 
	{ conv_to_pool_streams_1_num_data_valid sc_in sc_lv 11 signal 11 } 
	{ conv_to_pool_streams_1_fifo_cap sc_in sc_lv 11 signal 11 } 
	{ conv_to_pool_streams_1_full_n sc_in sc_logic 1 signal 11 } 
	{ conv_to_pool_streams_1_write sc_out sc_logic 1 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "w_49", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "w_49", "role": "default" }} , 
 	{ "name": "w_50", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "w_50", "role": "default" }} , 
 	{ "name": "w_51", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "w_51", "role": "default" }} , 
 	{ "name": "w_52", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "w_52", "role": "default" }} , 
 	{ "name": "w_53", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "w_53", "role": "default" }} , 
 	{ "name": "w_54", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "w_54", "role": "default" }} , 
 	{ "name": "w_55", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "w_55", "role": "default" }} , 
 	{ "name": "w_56", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "w_56", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fadd_32ns_32ns_32_7_full_dsp_1_U54", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U55", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fmul_32ns_32ns_32_4_max_dsp_1_U56", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U57", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	w_49 { ap_none {  { w_49 in_data 0 32 } } }
	w_50 { ap_none {  { w_50 in_data 0 32 } } }
	w_51 { ap_none {  { w_51 in_data 0 32 } } }
	w_52 { ap_none {  { w_52 in_data 0 32 } } }
	w_53 { ap_none {  { w_53 in_data 0 32 } } }
	w_54 { ap_none {  { w_54 in_data 0 32 } } }
	w_55 { ap_none {  { w_55 in_data 0 32 } } }
	w_56 { ap_none {  { w_56 in_data 0 32 } } }
	biases_buf { ap_none {  { biases_buf in_data 0 32 } } }
	conv_to_pool_streams_1 { ap_fifo {  { conv_to_pool_streams_1_din fifo_port_we 1 32 }  { conv_to_pool_streams_1_num_data_valid fifo_status_num_data_valid 0 11 }  { conv_to_pool_streams_1_fifo_cap fifo_update 0 11 }  { conv_to_pool_streams_1_full_n fifo_status 0 1 }  { conv_to_pool_streams_1_write fifo_data 1 1 } } }
}
