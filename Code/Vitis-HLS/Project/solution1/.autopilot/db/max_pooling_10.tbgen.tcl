...
set hasInterrupt 0
set C_modelName {max_pooling.10}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U241", "Parent" : "0"},
...
set Spec2ImplPortList { 
	conv_to_pool_streams_3 { ap_fifo {  { conv_to_pool_streams_3_dout fifo_port_we 0 32 }  { conv_to_pool_streams_3_num_data_valid fifo_status_num_data_valid 0 11 }  { conv_to_pool_streams_3_fifo_cap fifo_update 0 11 }  { conv_to_pool_streams_3_empty_n fifo_status 0 1 }  { conv_to_pool_streams_3_read fifo_data 1 1 } } }
	pool_to_flat_streams_3 { ap_fifo {  { pool_to_flat_streams_3_din fifo_port_we 1 32 }  { pool_to_flat_streams_3_num_data_valid fifo_status_num_data_valid 0 9 }  { pool_to_flat_streams_3_fifo_cap fifo_update 0 9 }  { pool_to_flat_streams_3_full_n fifo_status 0 1 }  { pool_to_flat_streams_3_write fifo_data 1 1 } } }
}
