...
set hasInterrupt 0
set C_modelName {cnn_Pipeline_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ weight_buf_1 float 32 regular {array 9 { 0 3 } 0 1 }  }
	{ weight_buf int 32 regular {array 72 { 1 3 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "weight_buf_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ weight_buf_1_address0 sc_out sc_lv 4 signal 0 } 
	{ weight_buf_1_ce0 sc_out sc_logic 1 signal 0 } 
	{ weight_buf_1_we0 sc_out sc_logic 1 signal 0 } 
	{ weight_buf_1_d0 sc_out sc_lv 32 signal 0 } 
...
set Spec2ImplPortList { 
	weight_buf_1 { ap_memory {  { weight_buf_1_address0 mem_address 1 4 }  { weight_buf_1_ce0 mem_ce 1 1 }  { weight_buf_1_we0 mem_we 1 1 }  { weight_buf_1_d0 mem_din 1 32 } } }
