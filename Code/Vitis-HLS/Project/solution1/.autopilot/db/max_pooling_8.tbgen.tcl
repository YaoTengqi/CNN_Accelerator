...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fcmp_32ns_32ns_1_2_no_dsp_1_U235", "Parent" : "0"},
...
set Spec2ImplPortList { 
	conv_to_pool_streams_1 { ap_fifo {  { conv_to_pool_streams_1_dout fifo_port_we 0 32 }  { conv_to_pool_streams_1_num_data_valid fifo_status_num_data_valid 0 11 }  { conv_to_pool_streams_1_fifo_cap fifo_update 0 11 }  { conv_to_pool_streams_1_empty_n fifo_status 0 1 }  { conv_to_pool_streams_1_read fifo_data 1 1 } } }
	pool_to_flat_streams_1 { ap_fifo {  { pool_to_flat_streams_1_din fifo_port_we 1 32 }  { pool_to_flat_streams_1_num_data_valid fifo_status_num_data_valid 0 9 }  { pool_to_flat_streams_1_fifo_cap fifo_update 0 9 }  { pool_to_flat_streams_1_full_n fifo_status 0 1 }  { pool_to_flat_streams_1_write fifo_data 1 1 } } }
}
