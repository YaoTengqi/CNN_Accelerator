...
reg   [31:0] weight_buf_load_57_reg_227;
reg   [31:0] weight_buf_load_58_reg_232;
wire    ap_CS_fsm_state4;
reg   [31:0] weight_buf_load_59_reg_247;
reg   [31:0] weight_buf_load_60_reg_252;
wire    ap_CS_fsm_state5;
reg   [31:0] weight_buf_load_61_reg_267;
reg   [31:0] weight_buf_load_62_reg_272;
reg   [31:0] weight_buf_load_63_reg_277;
wire    ap_CS_fsm_state6;
reg   [31:0] weight_buf_load_64_reg_282;
wire    ap_CS_fsm_state7;
wire   [31:0] grp_fu_156_p1;
reg   [31:0] conv8_reg_292;
...
reg   [31:0] w_6_reg_307;
wire   [31:0] grp_fu_173_p1;
reg   [31:0] w_7_reg_312;
wire   [31:0] grp_fu_177_p1;
reg   [31:0] w_8_reg_317;
wire   [31:0] grp_fu_181_p1;
reg   [31:0] w_9_reg_322;
wire   [31:0] grp_fu_185_p1;
reg   [31:0] w_1_reg_327;
wire   [31:0] grp_fu_189_p1;
reg   [31:0] w_2_reg_332;
wire   [31:0] grp_fu_193_p1;
reg   [31:0] w_3_reg_337;
wire    grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start;
wire    grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done;
wire    grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_idle;
wire    grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_ready;
wire   [9:0] grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_address0;
wire    grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_ce0;
wire   [9:0] grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_address1;
wire    grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_ce1;
wire   [31:0] grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_conv_to_pool_streams_0_din;
wire    grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_conv_to_pool_streams_0_write;
reg    grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg;
...
#0 ap_done_reg = 1'b0;
#0 ap_CS_fsm = 13'd1;
#0 grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg = 1'b0;
end

cnn_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state13) & (grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state12)) begin
            grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg <= 1'b1;
        end else if ((grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_ready == 1'b1)) begin
            grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (*) begin
    if ((grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done == 1'b0)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state13) & (grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign conv_to_pool_streams_0_din = grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_conv_to_pool_streams_0_din;

assign grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start = grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_ap_start_reg;

assign pad_img_address0 = grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_address0;

assign pad_img_address1 = grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_address1;

assign pad_img_ce0 = grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_ce0;

assign pad_img_ce1 = grp_convolution_Pipeline_conv_for_rows_win_for_rows_win_for_cols_fu_138_pad_img_ce1;
