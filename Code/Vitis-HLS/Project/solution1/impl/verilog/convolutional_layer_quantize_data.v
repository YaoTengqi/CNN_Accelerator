...
module convolutional_layer_quantize_data (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [63:0] one_half_i_cast_fu_178_p1;
...
convolutional_layer_quantize_data_mask_table_ROM_AUTO_1R #(
    .DataWidth( 52 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
mask_table_U(
...
convolutional_layer_quantize_data_one_half_table_ROM_AUTO_1R #(
    .DataWidth( 53 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
one_half_table_U(
...
convolutional_layer_fdiv_32ns_32ns_32_16_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 16 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
convolutional_layer_fpext_32ns_64_2_no_dsp_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .dout_WIDTH( 64 ))
...
assign data_V_1_fu_187_p2 = (p_Result_2_fu_181_p3 + one_half_i_cast_fu_178_p1);
...
assign one_half_i_cast_fu_178_p1 = one_half_reg_449;
...
endmodule //convolutional_layer_quantize_data
